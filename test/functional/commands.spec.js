...
test.group('Commands', (group) => {
  ...
  test('acl:setup', async (assert) => {
    ...
    assert.equal(paths[0], 'create_permission_role_table.js')
    assert.equal(paths[1], 'create_permission_user_table.js')
    assert.equal(paths[2], 'create_permissions_table.js')
    assert.equal(paths[3], 'create_role_user_table.js')
    assert.equal(paths[4], 'create_roles_table.js')
  })
})
